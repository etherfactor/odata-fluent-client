...
describe("EntitySetWorkerImpl", () => {
  test("should resolve data promise with correct entities from promise response", async () => {
  ...
  test("should resolve count and data promise with correct values from streaming response", async () => {
    const entities: TestEntity[] = [
      { id: 3, name: "Entity3" },
      { id: 4, name: "Entity4" },
    ];
  ...
  test("should reject promises when validator returns an error in promise response", async () => {
    const entities: TestEntity[] = [
      { id: 1, name: "Entity1" },
      { id: 5, name: "Entity2" },
    ];
  ...
  test("should reject promises when validator returns an error in streaming response", async () => {
    const entities: TestEntity[] = [
      { id: 5, name: "Entity5" },
      { id: 6, name: "Entity6" },
    ];
  ...
  test("should call adapter.invoke with correct configuration", () => {
    const entities: TestEntity[] = [
      { id: 7, name: "Entity7" }
    ];
    const fullResponse = {
